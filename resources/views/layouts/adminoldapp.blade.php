...
<html lang="en">
    ...
    <head>
	    ...
	    <title>Net Working App</title>

	    <link rel="icon" type="image/png" href="{{url('images/icons/nw-icon.ico')}}"/>
    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo">
        ...
        <!--<div class="page-wrapper" > descomentar -->
            <!-- BEGIN HEADER -->
                ...
                <div class="page-header-inner ">
                    ...
                    <div class="page-logo">
                        <a href="{{url('admin/home')}}">
                            <img src="{{ url('images/logos/nwapplogo.png')}}" alt="NWApp Logo" class="logo-default" width="42" style="margin-top: 5px; margin-left: -15px;" /> </a>
                          ...
                          <!--  <li class="dropdown dropdown-extended dropdown-tasks" id="header_task_bar">
                            ...
                            <li class="dropdown dropdown-user">
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    ...
                                    <span class="username username-hide-on-mobile"> <i class="icon-user"></i> {{Auth::user()->userFirstName}} </span>
            ...
            <div class="page-container" >
                ...
                <div class="page-sidebar-wrapper">
                    ...
                    <div class="page-sidebar navbar-collapse collapse">
                        ...
                        @if(Auth::user()->id == 1387227508 && (isset($eventId) && ($eventId !== null)))
                         <!--<li class="nav-item">
                                <a href="javascript:;" class="nav-link nav-toggle">
                                    <i class="icon-layers"></i>
                                    <span class="title">Catálogos</span>
                                ...
                                <ul class="sub-menu">
                                    <li class="nav-item">
                                        <a href="{{ route('catalogs-create')}}" onclick="event.preventDefault();
                                          ...
                                          <span class="title">Crear Catálogo</span>
                                        </a>
                                    </li>
                        ...
                        @endif      
                            ...
                            @endif
                             ...
                             @if(isset($permissions) && ($permissions==1 || $permissions==2) && isset($eventId))
                                ...
                                <form id="full-users-admin-form-1" action="{{ route('full-users-admin') }}" method="POST" style="display: none;">
                                      {{ csrf_field() }}
                                      <input type="hidden" name="eventId" value="{{$eventId}}">
                                </form>
                                @if(isset($permissions) && $permissions==1)
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li class="nav-item  ">        
                                                <a href=""  disabled="disabled" onclick="event.preventDefault();
                                                    ...
                                                    <i class="fa fa-cog"></i>
                                                    <span class="title">Configurar Ticket</span>
                                             ...
                                             <li class="nav-item  ">        
                                                <a href=""  disabled="disabled" onclick="event.preventDefault();
                                                    ...
                                                    <span class="title">Enviar Tickets</span>
                                            ...
                                            <li class="nav-item  ">        
                                                <a href=""  disabled="disabled" onclick="event.preventDefault();
                                                    ...
                                                    <span class="title">Recepción de Tickets</span>
