	...
	<div class="row" style="margin-top: -5px;">
		<div class="col-md-12" style="margin-top:0px;">
			...
			<div class="portlet light">
				...
				<form class="form-horizontal" method="POST" action="" id="form-field-create">
        	...
        	if(uData.status == 'success'){
        		...
        		if(uData.actionId == 1){
	                ...
	                var rowNode = t.row.add( [
	                    ...
	                    uData.controlName,
	                    uData.controlTypeName,
	                    uData.dataTypeName,
	                    uData.maxlenght,
	                    "<button onclick='editField("+ uData.Id+");' class='btn btn-xs btn-default sweet-8'><i class='fa fa-edit'></i> Editar</button> " +
			              "<button onclick='disableField("+ uData.Id +");' class='btn btn-xs btn-default sweet-8'><i class='fa fa-trash'></i> Desabilitar</button>"
	                ] ).draw().node();
        		...
        		$('#form-field-create').trigger("reset");
