...
<div class="page-title">
	<h3><!--<i class="fa fa-edit"></i>--> Visitantes {{$eventName}} </h3>
</div>
<div class="page-bar">
	<ul class="page-breadcrumb">
        ...
        <li>
            <a href="#">Administración de Visitantes</a>
		...
		<div class="portlet light bordered">
	        ...
	        <div class="portlet-body form">
	        	<div class="row">
	        		...
	        		<div class="col-md-12">
	        			<form role="form" method="POST" action="{{route('full-visitors-admin')}}">
			              	{{ csrf_field() }}
	    		    		<input type="hidden" name="eventId" id="eventId" value="{{$eventId}}">
	    		    		<div class="col-md-12">
	                			<label for="searchParams">Ingrese correo/nombres del visitante</label>
	                			<input class="form-control" id="searchParams" name="searchParams"><br>
	                		</div>
	                		<div class="col-md-12">
	    						<button style="margin-top:-5px" id="btn-send-invitations" type="submit" class="btn blue-soft btn-md pull-left" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Enviado ticket(s)..."><i class="fa fa-search"></i> Buscar Visitante</button>
	    					</div>
		  				  </form>
	        		...
	        		<div class="col-md-12 col-sm-12" style="margin-top: 10px">
		                ...
		                @if($eventAdminStatus == 1)
				        	...
				        	@if($countUsers >0)
				        	<div class="col-md-12 col-sm-12" style="padding-bottom: 20px">
				        		<form id="excelGenerateForm" role="form" class="form-horizontal" method="post" action="{{url('admin/visitors/full-visitors-report')}}" target="_blank">
				        			{{ csrf_field() }}
		    		    			<input type="hidden" name="eventId" id="eventId" value="{{$eventId}}">
					                <div class="form-body">
					                	 <button type="submit" href=""  class="btn green pull-right"><i class="fa fa-file-excel-o"></i> Reporte General de Visitantes</button>
					                </div>
				            	</form>
				        	</div>
				        	@endif
				        ...
				        @else
					      	 ...
					      	 <div class="col-md-12" style="margin-top: 20px;">
					            <div class="alert alert-danger">
					                <strong>Evento cerrado!</strong> No se pueden administrar visitantes en este evento.
					            </div>
					        </div>
			        ...
			        <div class="col-md-12 col-sm-12">
			        	<div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">{{$tableHeaderText}}</h3>
                            </div>
                                ...
                                <div class="table-scrollable">
                                    <table id="asisigned-visitors" class="table table-striped  table-hover  order-column" style="width: 100%">
                                        ...
                                        <tbody>
                                            ...
                                            @else
												<tr>
                                            		<td colspan="6" style="text-align: center"> No se han encotrado coincidencias, inténtelo de nuevo. </td>
                                            	</tr>
                                            @endif
                                         </tbody>
                                    </table>
                                 ...
                                 @if($countUsers>15) {!!  $userAsigned->appends(Request::except('page'))->links() !!} @endif
			                                	...
			                                	<div class="form-body">
								                   ...
								                   <!-- <div class="form-group custom-form-group">
								                    ...
								                    <div class="form-group custom-form-group">
								                        ...
								                        <div class="col-md-6">
								                           <input id="userPhone" name="userPhone" type="text"  class="form-control" placeholder="50504040" maxlength="15" required/>
								                        </div>
								                    </div>
...
<!--Excel File Download -->
<script type="text/javascript">
	$('#excelGenerateForm.').submit(function( event ) {
	    swal({
	        title: "",
	        text: "Descargando archivo...",
	        imageUrl: "{{url('images/loader.gif')}}",
