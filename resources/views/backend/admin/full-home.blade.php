        ...
        <div class="col-md-4">
            <div class="mt-widget-3 border-grey-salt">
                <div class="mt-head bg-blue-hoki">
                    ...
                    <span class="mt-head-date"> <h2>1</h2> </span>
                    ...
                    <div class="table-scrollable table-scrollable-borderless">
                        <table class="table table-hover table-light">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="fit">
                                        <img class="user-pic rounded" src="{{url('images/montanas.jpg')}}"> </td>
                                    <td>
                                        <a href="{{url('/sponsor/events/check-event/')}}/1" class="primary-link">{{ $lastevent->eventName }}</a>
                                    </td>
                                    <td> {{$lastevent->userFirstName}} {{$lastevent->userLastName}} </td>
                                    <td><span class="pull-right"> {{ date_format($lastevent->created_at, 'd-M-Y')}}</span></td>
                                </tr>
                                @endforeach
                        </tbody></table>
                    </div><br>
