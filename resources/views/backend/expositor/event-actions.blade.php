    ...
    <div id="page-menu" class="no-sticky" style="margin-top:-1px !important">
        <div id="page-menu-wrap" class="parent-menu">
            <div class="container clearfix">
                <div class="menu-title">Intended Parent <span>Menu</span></div>
                <nav> <!-- class="custom-filter" -->
                    <ul data-active-class="current">
                        <li><a href="http://omegafamilygenetics.com/public/searchprofile" data-filter=".pf-icons"><i style="font-size: 12px;" class="icon-user"></i> My Profile</a></li>
                        <li><a href="http://omegafamilygenetics.com/public/show-favorites"><i style="font-size: 12px;" class="icon-star"></i> My Favorites</a></li>
                        <li><a href="http://omegafamilygenetics.com/public/app/search"><i style="font-size: 12px;" class="icon-search"></i> Search Egg Donors</a></li>
                         <li><a href="http://omegafamilygenetics.com/public/logout">Log out</a></li>
                    </ul>
                </nav>
