               ...
               <!-- <div class="row">
                ...
                <div class="panel-body panel-body-login">
                    ...
                    <form id="login-form" class="form-horizontal" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="group">
                            <input class="form-control custom-form-control" type="email" id="userEmail" name="userEmail" value="{{old('userEmail')}}" ata-trigger="manual" placeholder="Correo Electrónico" autofocus>
                        ...
                        <div class="group">
                                ...
                                <input class="form-control custom-form-control" type="password" id="password" name="password" placeholder="Contraseña">
                     ...
                     <!--   <div class="form-group">
                        ...
                        <div class="group nomargin nopadding login-create-account">
                            ...
                            @else
                        	   <span>¿No tienes una cuenta? <a id="get-create-fields2" href="{{url('visitantes/registro')}}">Crear</a></span>
                            @endif
                        </div>
