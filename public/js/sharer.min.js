(function(o,r){
	"use strict";var i=function(t){this.elem=t};i.init=function(){
		var t=r.querySelectorAll("[data-sharer]"),e,a=t.length;
		for(e=0;e<a;e++){t[e].addEventListener("click",i.add)}};
		i.add=function(t){var e=t.currentTarget||t.srcElement;var a=new i(e);a.share()};
		i.prototype={constructor:i,getValue:function(t,e){e=e===undefined?"":e;
